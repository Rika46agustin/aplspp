...
class MasterData extends CI_Controller
{
    ...
    public function list_petugas()
    {
        ...
        foreach ($data as $petugas) {
            ...
            echo '<td>
                <a href="#" data-toggle="modal" data-target="#modalEdit' . $petugas->ID_PETUGAS . '" class="btn btn-sm btn-dark" data-popup="tooltip" data-placement="top" title="Edit Data">Edit</a>
                <a href="' . base_url('masterdata/petugas_del/') .  $petugas->ID_PETUGAS . '" class="btn btn-sm btn-danger tombol-Delete">Delete</a>
                </td>';
            echo '</tr>';
            echo "<script>
    ...
    public function list_siswa()
    {
        ...
        foreach ($data as $siswa) {
            ...
            echo '<td>
                <a href="#" data-toggle="modal" data-target="#modalEdit' . $siswa->NISN . '" class="btn btn-sm btn-dark" data-popup="tooltip" data-placement="top" title="Edit Data">Edit</a>
    ...
    public function add_siswa()
    {
        ...
        $this->form_validation->set_rules('no_telp', 'No.Telp', 'required|trim|min_length[12]|numeric', [
    ...
    public function jurusan()
    {
        ...
        $this->form_validation->set_rules('jurusan', 'Jurusan', 'required|is_unique[tbl_jurusan.JURUSAN]', [
            'required' => 'Kompetensi Keahlian tidak boleh kosong.',
            'is_unique' => 'Jurusan Yang Anda Masukkan Sudah Ada!',
        ]);
        // $this->form_validation->set_rules('jurusan', 'Jurusan', 'required', [
        //     'required' => 'Kompetensi Keahlian tidak boleh kosong.',
        // ]);
