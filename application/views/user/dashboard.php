        ...
        <div class="container-fluid">
            ...
            <?php if ($this->session->userdata('level') == 'Admin') : ?>
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6">
                        <!-- small box -->
                        <div class="small-box bg-dark" style="height: 142px;">
                            <div class="inner">
...
<div class="card text-center">
    ...
    <div class="card-header bg-primary text-dark">
      ...
      <marquee> <h2><b>Selamat Datang Di Aplikasi Pembayaran SPP</b></h2></marquee>
    </div>
    <div class="card-body">
...
<div class=" card text-center">
    ...
    <div class="card-body">
    <h1><i class="fa fa-user-circle"></i></h1>
        <b><h2 class="card-text"></h2>Anda login Sebagai Siswa</b>
        <p>Sesuai dengan NISN dan NIS yang benar</p>
       
    </div>
        <div class="card-footer text-Light bg-dark">
       <h2><b>"Berjuang itu capek,Namun kesuksesan butuh perjuangan"</h2></b>
        </div>
    <link rel="stylesheet" href="font-awesome/css/font-awesome.min.css" />
</div>
</div>
